...
```{r growthlit, echo = FALSE}
knitr::include_graphics("./static/pictures/growthpapers.png")
```
...
```{r none, echo=FALSE}
knitr::include_graphics("./static/pictures/no_var.png")
```

---
# Annual changes
```{r annual, echo=FALSE}
knitr::include_graphics("./static/pictures/annual_var.png")
```
...
# Cohort changes
```{r cohort, echo=FALSE}
knitr::include_graphics("./static/pictures/cohort_var.png")
```

---
# Initial size
```{r init, echo=FALSE}
knitr::include_graphics("./static/pictures/init_var.png")
```

---
# Estimation settings
* 4 models per species
* Needed a strong prior on $\sigma_p$ (process error) and $\sigma_o$ (observation error) 
* 4 chains, 1000 warmup iterations
...
---
# Preliminary Results - Pacific hake 
```{r show_hake, echo = FALSE}
