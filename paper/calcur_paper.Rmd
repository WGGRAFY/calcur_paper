...
|             | $x_{0,t} \sim N(x_c, \sigma_c^2)$                                                  |                                                  |
+-------------+------------------------------------------------------------------------------------+--------------------------------------------------+
| $S_6$       | \$x\_{a,t} = \\beta x\_{a-1,t-1} + \\gamma_t + \\beta_y T\_{y-a} + \\varepsilon \$ | Annual deviations with temperature effects       |
+-------------+------------------------------------------------------------------------------------+--------------------------------------------------+
...
|             |                                                                                    |                                                  |
|             | \$x\_{0,t} \\sim N(x_c+\\beta_iT\_{y-a}, \\sigma_c\^2) \\forall t\$                |                                                  |
+-------------+------------------------------------------------------------------------------------+--------------------------------------------------+
