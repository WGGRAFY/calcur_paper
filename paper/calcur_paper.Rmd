...
+---------+------------------------------------------------------------------------------------------------------------+---------------------------------------------------+---------+
| $S_5$   | $x_{a,t} = \beta x_{a-1,t-1} + \gamma_t + \nu_c + \varepsilon$ $x_{0,t} \sim N(x_c, \sigma_c^2)$           | Annual, cohort, and initial size deviations       |         |
+---------+------------------------------------------------------------------------------------------------------------+---------------------------------------------------+---------+
| $S_6$   | $x_{a,t} = \beta x_{a-1,t-1} + \gamma_t + \lambda_y T_{y-1} + \varepsilon$                                 | Annual deviations with temperature effects        |         |
+---------+------------------------------------------------------------------------------------------------------------+---------------------------------------------------+---------+
| $S_7$   | $x_{a,t} = \beta x_{a-1,t-1} + \nu_c + \lambda_c T_{y-a} + \varepsilon$                                    | Cohort deviations with temperature effects        |         |
+---------+------------------------------------------------------------------------------------------------------------+---------------------------------------------------+---------+
| $S_8$   | $x_{a,t} = \beta x_{a-1,t-1} + \varepsilon$ \| $x_{0,t} \sim N(x_c+\beta_iT_{y-a}, \sigma_c^2) \forall t$  | Initial size deviations with temperature effects  |         |
+---------+------------------------------------------------------------------------------------------------------------+---------------------------------------------------+---------+
