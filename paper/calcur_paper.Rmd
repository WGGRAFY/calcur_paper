...
+-------------+------------------------------------------------------------------------------------+--------------------------------------------------+
| $S_5$       | $x_{a,t} = \beta x_{a-1,t-1} + \gamma_t + \nu_c + \varepsilon$               | Annual, cohort, and initial size deviations      |
|             |                                                                                    |                                                  |
|             | $x_{0,t} \sim N(x_c, \sigma_c^2)$                                                  |                                                  |
+-------------+------------------------------------------------------------------------------------+--------------------------------------------------+
| $S_6$       | $x_{a,t} = \beta x_{a-1,t-1} + \gamma_t + \lambda_y T_{y-a} + \varepsilon$ | Annual deviations with temperature effects       |
+-------------+------------------------------------------------------------------------------------+--------------------------------------------------+
...
|             |                                                                                    |                                                  |
|             | $x_{0,t} \sim N(x_c+\beta_iT_{y-a}, \sigma_c^2) \forall t$                |                                                  |
+-------------+------------------------------------------------------------------------------------+--------------------------------------------------+
